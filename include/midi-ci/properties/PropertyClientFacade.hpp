...
public:
    ...
    void send_get_property_data(const messages::GetPropertyData& msg);
    ...
    void send_set_property_data(const messages::SetPropertyData& msg);
    ...
    void process_property_capabilities_reply(const messages::PropertyGetCapabilitiesReply& msg);
    void process_get_data_reply(const messages::GetPropertyDataReply& msg);
...
public:
    ...
    virtual void process_property_subscription_result(void* sub, const messages::SubscribePropertyReply& msg) = 0;
