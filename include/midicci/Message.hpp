...
class ProfileReply : public SinglePacketMessage {
    const std::vector<MidiCIProfileId> enabled_profiles_;
    const std::vector<MidiCIProfileId> disabled_profiles_;

public:
    ProfileReply(const Common& common, const std::vector<MidiCIProfileId>& enabled_profiles,
...
public:
    ProfileDetailsReply(const Common& common, const MidiCIProfileId& profile_id,
