...
std::vector<std::vector<uint8_t>> Message::serialize_multi(const MidiCIDeviceConfiguration& config) const {
    return {};
}
...
std::vector<std::vector<uint8_t>> SinglePacketMessage::serialize_multi(const MidiCIDeviceConfiguration& config) const {
...
std::vector<std::vector<uint8_t>> PropertyMessage::serialize_multi(const MidiCIDeviceConfiguration& config) const {
