...
public:
    explicit Impl(uint8_t grp, uint8_t addr, const midicci::profilecommonrules::MidiCIProfileId& prof,
    ...
    midicci::profilecommonrules::MidiCIProfileId profile_;
...
const midicci::profilecommonrules::MidiCIProfileId& MidiCIProfileState::get_profile() const noexcept {
