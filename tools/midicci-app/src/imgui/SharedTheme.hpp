...
inline void SetupImGuiStyle(ThemeMode mode = ThemeMode::Dark)
{
	...
	const ImVec4 accent = ImVec4(0.71764708f, 0.43137255f, 0.47450981f, 1.0f); // #b76e79
	const ImVec4 accentHover = ImVec4(0.80784315f, 0.52156866f, 0.56470591f, 1.0f);
	const ImVec4 accentActive = ImVec4(0.90588242f, 0.61960787f, 0.66666669f, 1.0f);
	const ImVec4 accentSoft = ImVec4(0.96078438f, 0.79215688f, 0.83137262f, 0.8f);
	...
	if (mode == ThemeMode::Dark) {
		...
		style.Colors[ImGuiCol_FrameBgActive] = ImVec4(accentActive.x, accentActive.y, accentActive.z, 0.0f);
		...
		style.Colors[ImGuiCol_SliderGrab] = ImVec4(accent.x, accent.y, accent.z, 0.4f);
		style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(accentHover.x, accentHover.y, accentHover.z, 0.5f);
	} else {
		...
		style.Colors[ImGuiCol_SliderGrab] = ImVec4(accent.x, accent.y, accent.z, 0.7f);
		style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(accentHover.x, accentHover.y, accentHover.z, 0.9f);
	}
	if (mode == ThemeMode::Dark) {
		...
		style.Colors[ImGuiCol_Header] = ImVec4(accent.x, accent.y, accent.z, 0.31f);
		style.Colors[ImGuiCol_HeaderHovered] = ImVec4(accentHover.x, accentHover.y, accentHover.z, 0.8f);
		...
		style.Colors[ImGuiCol_ResizeGripActive] = ImVec4(accentActive.x, accentActive.y, accentActive.z, 0.95f);
	} else {
		style.Colors[ImGuiCol_Button] = accent;
		style.Colors[ImGuiCol_ButtonHovered] = accentHover;
		style.Colors[ImGuiCol_ButtonActive] = accentActive;
		style.Colors[ImGuiCol_Header] = ImVec4(accent.x, accent.y, accent.z, 0.25f);
		style.Colors[ImGuiCol_HeaderHovered] = ImVec4(accentHover.x, accentHover.y, accentHover.z, 0.6f);
		style.Colors[ImGuiCol_HeaderActive] = ImVec4(accentHover.x, accentHover.y, accentHover.z, 0.8f);
		...
		style.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(accentHover.x, accentHover.y, accentHover.z, 0.8f);
		style.Colors[ImGuiCol_ResizeGripActive] = ImVec4(accentActive.x, accentActive.y, accentActive.z, 0.95f);
	}
	if (mode == ThemeMode::Dark) {
		style.Colors[ImGuiCol_Tab] = ImVec4(accent.x, accent.y, accent.z, 0.931f);
		style.Colors[ImGuiCol_TabHovered] = ImVec4(accentHover.x, accentHover.y, accentHover.z, 0.8f);
		...
		style.Colors[ImGuiCol_TableHeaderBg] = ImVec4(accentSoft.x, accentSoft.y, accentSoft.z, 0.5f);
		...
		style.Colors[ImGuiCol_DragDropTarget] = ImVec4(accentHover.x, accentHover.y, accentHover.z, 0.95f);
		style.Colors[ImGuiCol_NavHighlight] = ImVec4(accentHover.x, accentHover.y, accentHover.z, 0.8f);
		...
		style.Colors[ImGuiCol_Tab] = ImVec4(accent.x, accent.y, accent.z, 0.7f);
		style.Colors[ImGuiCol_TabHovered] = ImVec4(accentHover.x, accentHover.y, accentHover.z, 0.8f);
		...
		style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(accentSoft.x, accentSoft.y, accentSoft.z, 1.0f);
		style.Colors[ImGuiCol_PlotLines] = ImVec4(0.5f, 0.5f, 0.5f, 1.0f);
		style.Colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.0f, 0.42745098f, 0.34901962f, 1.0f);
		style.Colors[ImGuiCol_PlotHistogram] = ImVec4(0.8980392f, 0.69803923f, 0.0f, 1.0f);
		style.Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(1.0f, 0.44705883f, 0.0f, 1.0f);
		style.Colors[ImGuiCol_TableHeaderBg] = accentSoft;
