...
VirtualizedLogWidget::VirtualizedLogWidget(midicci::tooling::CIToolRepository* repository, QWidget *parent)
    : QTableWidget(parent)
...
void VirtualizedLogWidget::createLogRow(int row, const midicci::tooling::LogEntry& entry)
{
...
void LogWidget::setupUI()
{
    ...
    m_logTable = new VirtualizedLogWidget(m_repository, this);
