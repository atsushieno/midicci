...
public:
    explicit Impl(uint8_t grp, uint8_t addr, const MidiCIProfileId& prof,
...
const MidiCIProfileId& MidiCIProfileState::get_profile() const noexcept {
